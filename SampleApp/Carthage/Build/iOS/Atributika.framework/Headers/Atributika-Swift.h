...
#ifndef ATRIBUTIKA_SWIFT_H
#define ATRIBUTIKA_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Atributika",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
IB_DESIGNABLE
SWIFT_CLASS("_TtC10Atributika15AttributedLabel")
@interface AttributedLabel : UIView
- (void)prepareForInterfaceBuilder;
@property (nonatomic) IBInspectable BOOL isEnabled;
@property (nonatomic) IBInspectable BOOL isSelectable;
@property (nonatomic) IBInspectable NSInteger numberOfLines;
@property (nonatomic) IBInspectable NSLineBreakMode lineBreakMode;
@property (nonatomic) IBInspectable BOOL adjustsFontForContentSizeCategory SWIFT_AVAILABILITY(ios,introduced=10.0);
