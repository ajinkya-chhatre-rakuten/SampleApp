...
@implementation RMIGetTelephoneRequest
...
{
    return @"memberinfo_read_telephone";
}
...
{
    static NSString *path = @"/engine/api/MemberInformation/GetTelephone/20110901";
...
@implementation RMIGetTelephoneRequest (RMIConvenience)
