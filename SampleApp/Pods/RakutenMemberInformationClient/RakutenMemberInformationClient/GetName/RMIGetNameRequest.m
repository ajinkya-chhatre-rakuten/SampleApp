...
@implementation RMIGetNameRequest
...
{
    static NSString *path = @"engine/api/MemberInformation/GetName/20110901";
...
@implementation RMIGetNameRequest (RMIConvenience)
