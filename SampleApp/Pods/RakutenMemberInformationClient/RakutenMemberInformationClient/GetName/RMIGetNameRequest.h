...
/**
 *  Class for issuing requests for Rakuten App Engine's MemberInformation/GetName endpoint.
 *
 ...
 *
 *  @note Requests made with this class require tokens with the @c "memberinfo_read_name" scope.
 *  @see https://confluence.rakuten-it.com/confluence/display/RAED/Get+Name+API+version+2011-09-01
 *
 *  @class RMIGetNameRequest RMIGetNameRequest.h <RakutenMemberInformationClient/RMIGetNameRequest.h>
 *  @ingroup RMIRequests
 *  @ingroup RMICoreComponents
 */
RWC_EXPORT @interface RMIGetNameRequest : NSObject <RWCURLRequestSerializable, RWCAppEngineScopedEndpoint, NSCopying, NSSecureCoding>
 ...
 *
 *  @note This token must be permitted to the @c "memberinfo_read_name" scope
 */
...
/**
 *  Convenience methods for RMIGetNameRequest
 */
@interface RMIGetNameRequest (RMIConvenience)

/**
 *  Convenience factory for generating Japan Ichiba name requests.
 *
 *  @see RMIGetNameRequest::initWithAccessToken:
 *
