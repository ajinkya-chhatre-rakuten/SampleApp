...
@implementation RMIGetUserInfoRequest
...
{
    return @"memberinfo_read_details";
}
...
{
    static NSString *path = @"/engine/api/MemberInformation/GetUserInfo/20130831";
...
@implementation RMIGetUserInfoRequest (RMIConvenience)
