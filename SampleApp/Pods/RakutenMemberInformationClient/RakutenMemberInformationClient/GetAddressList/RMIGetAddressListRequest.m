...
@implementation RMIGetAddressListRequest
...
{
    return @"memberinfo_read_address_list";
}
...
{
    static NSString *path = @"engine/api/MemberInformation/GetAddressList/20141031";
...
@implementation RMIGetAddressListRequest (RMIConvenience)
