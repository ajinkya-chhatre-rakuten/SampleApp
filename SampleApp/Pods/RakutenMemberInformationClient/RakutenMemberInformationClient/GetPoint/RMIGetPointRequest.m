...
@implementation RMIGetPointRequest
...
{
    static NSString *path = @"engine/api/MemberInformation/GetPoint/20160519";
...
@implementation RMIGetPointRequest (RMIConvenience)
