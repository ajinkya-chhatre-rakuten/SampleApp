...
@implementation RMIGetBasicInfoRequest
...
{
    static NSString *path = @"engine/api/MemberInformation/GetBasicInfo/20110901";
...
@implementation RMIGetBasicInfoRequest (RMIConvenience)
