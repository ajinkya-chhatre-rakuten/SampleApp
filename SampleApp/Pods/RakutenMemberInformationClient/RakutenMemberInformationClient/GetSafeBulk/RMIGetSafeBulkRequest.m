...
@implementation RMIGetSafeBulkRequest
...
{
    return @"memberinfo_read_safebulk";
}
...
{
    static NSString *path = @"/engine/api/MemberInformation/GetSafeBulk/20150218";
...
@implementation RMIGetSafeBulkRequest (RMIConvenience)
