...
@implementation RMIGetEmailRequest
...
{
    static NSString *path =@"engine/api/MemberInformation/GetMail/20110901";
...
@implementation RMIGetEmailRequest  (RMIConvenience)
