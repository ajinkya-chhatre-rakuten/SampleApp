...
@implementation RMIGetLimitedTimePointRequest
...
{
	return @"memberinfo_read_limited_point";
}
...
{
	static NSString *path = @"/engine/api/MemberInformation/GetLimitedTimePoint/20170516";
...
@implementation RMIGetLimitedTimePointRequest (RMIConvenience)
