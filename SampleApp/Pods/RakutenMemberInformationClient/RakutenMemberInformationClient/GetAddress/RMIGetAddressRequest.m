...
@implementation RMIGetAddressRequest
...
{
    return @"memberinfo_read_address";
}
...
{
    static NSString *path = @"engine/api/MemberInformation/GetAddress/20110901";
...
@implementation RMIGetAddressRequest (RMIConvenience)
