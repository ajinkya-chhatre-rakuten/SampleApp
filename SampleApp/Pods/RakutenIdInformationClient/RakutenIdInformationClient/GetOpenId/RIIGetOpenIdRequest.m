...
@implementation RIIGetOpenIdRequest
...
{
    static NSString *path = @"engine/api/IdInformation/GetOpenID/20110601";
...
@implementation RIIGetOpenIdRequest (RIIConvenience)
