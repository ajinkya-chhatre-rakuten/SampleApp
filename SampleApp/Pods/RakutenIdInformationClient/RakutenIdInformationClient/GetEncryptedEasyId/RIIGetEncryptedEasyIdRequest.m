...
@implementation RIIGetEncryptedEasyIdRequest
...
{
    return @"idinfo_read_encrypted_easyid";
}
...
{
    static NSString *path = @"engine/api/IdInformation/GetEncryptedEasyId/20140617";
...
@implementation RIIGetEncryptedEasyIdRequest (RIIConvenience)
